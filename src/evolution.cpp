...
namespace EVOLUTION {
    ...
    ): population_size(population_size), selection_ratio(selection_ratio), mutation_ratio(mutation_ratio), input_length(input_length), output_length(output_length), neuron_counts(neuron_counts), fitness_function(fitness_function) {
